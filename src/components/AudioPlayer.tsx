  ...
  return (
    <div className="w-full max-w-2xl mx-auto mb-2 md:mb-8">
      <div className="bg-card border border-border rounded-xl md:rounded-2xl overflow-hidden shadow-lg">
        ...
        <div
          className={`flex flex-col items-center gap-3 md:gap-6 px-3 py-3 md:px-6 md:py-6 min-h-[180px] md:min-h-[280px] ${
        ...
        <div className="border-t border-border bg-muted/30 px-2 py-2 md:px-6 md:py-4">
          <div className="flex flex-col items-center gap-1 md:gap-2 text-[10px] md:text-sm text-foreground">
              ...
              {songStatuses.map((entry) => {
                ...
                return (
                  <button
                    ...
                    className={`relative inline-flex flex-col items-center justify-center text-xl md:text-2xl transition p-0.5 md:p-1 min-w-[32px] min-h-[32px] md:min-w-[44px] md:min-h-[44px] ${
