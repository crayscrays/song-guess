      ...
      <div className="max-w-4xl mx-auto pt-8">
        ...
        <div className="mt-12 text-center max-w-md mx-auto">
          <p className="text-xs text-muted-foreground leading-relaxed">
            Note: This is a demo version using placeholder audio. To use real Jay Chou songs, 
            you'll need to integrate with YouTube API or provide your own audio files with proper licensing.
          </p>
        </div>
      </div>
    </div>
